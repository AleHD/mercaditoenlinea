...
public class MercadoEnLineaController {
	...
	public ResponseEntity<?> deleteProduct(@RequestBody ProductoDto productoDto) throws IOException{
		return ResponseEntity.ok().body(iProductoService.deleteProducto(productoDto));
	}
