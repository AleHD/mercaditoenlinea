...
public class MercadoEnLineaController {
    ...
    @GetMapping("compra/")
    public ResponseEntity<?> comprarProducto(@RequestParam String correocomprador, @RequestParam String correovendedor, @RequestParam Long idproducto) throws  MessagingException{
        return ResponseEntity.ok().body(iProductoService.compra(correocomprador, correovendedor, idproducto));
    }
}
